...
`;customElements.define("rl-display",c);document.head.append(y(D));function f(r,e){for(let t in e)r.style.setProperty(t,e[t])}function v(r,e){e.ch&&(r.textContent=e.ch);let t={};e.fg&&(t.color=e.fg),e.bg&&(t["background-color"]=e.bg),f(r,t)}export{c as default};
