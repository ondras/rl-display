...
`;customElements.define("rl-display",m);document.head.append(b(w));function D(a,e){for(let t in e)a.style.setProperty(t,e[t])}function B(a,e){e.ch&&(a.textContent=e.ch);let t={};e.fg&&(t.color=e.fg),e.bg&&(t["background-color"]=e.bg),D(a,t)}export{x as EFFECTS,m as default};
